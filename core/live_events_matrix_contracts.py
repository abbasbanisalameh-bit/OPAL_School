...
def audit_live_events_matrix(root: Path | None = None) -> list[AuditIssue]:
    ...
    # R113 intentionally replaces the large live-events matrix on the executive
    # dashboard with compact operational details. The live service itself remains
    # authoritative and is still audited below.
