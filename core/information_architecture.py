...
GATEWAYS: tuple[InformationGateway, ...] = (
    # Management: every daily route resolves back to its owning sidebar gateway.
    InformationGateway("management.home", "الرئيسية", MANAGEMENT, "dashboard:home", "لوحة الإدارة الرئيسية."),
    InformationGateway("management.students", "الطلبة", MANAGEMENT, "students:student_list", "بيانات الطالب وقيده وملفه الشامل."),
    InformationGateway("management.attendance", "الطلبة", MANAGEMENT, "attendance_v2:dashboard", "الغياب والمغادرة وإغلاق السجلات."),
    InformationGateway("management.student_finance", "المالية", MANAGEMENT, "accounting:dashboard", "الرسوم والمدفوع والمتبقي."),
    InformationGateway("management.payments", "المالية", MANAGEMENT, "admissions:fee_payment_create", "تسجيل دفعات الطالب أو الأسرة."),
    InformationGateway("management.receipts", "المالية", MANAGEMENT, "admissions:fee_payment_archive", "البحث عن الإيصالات وعرضها وطباعتها."),
    InformationGateway("management.marks", "الامتحانات", MANAGEMENT, "exams:exam_list", "الامتحانات والعلامات والتحليل."),
    InformationGateway("management.teachers", "المعلمين", MANAGEMENT, "teachers:dashboard", "المعلمون والتكليفات."),
    InformationGateway("management.payroll", "المالية", MANAGEMENT, "teachers:payroll_center", "الرواتب والسلف والخصومات."),
    InformationGateway("management.notifications", "التواصل والمتابعة", MANAGEMENT, "enterprise_ops:dashboard", "التواصل والمتابعة من لوحة الإدارة."),
    InformationGateway("management.transport", "المواصلات", MANAGEMENT, "transport:transport-dashboard", "الرحلات والسائقون والتعيينات والتتبع."),
