...
class SchoolSettingsForm(forms.ModelForm):
    class Meta:
        model = School
        fields = ["name", "official_name", "logo", "dashboard_image", "dashboard_image_position", "phone", "email", "address", "is_active"]
        labels = {
            "name": "اسم المدرسة",
            "official_name": "الاسم الرسمي",
            "logo": "شعار المدرسة",
            "dashboard_image": "صورة لوحة الرئيسية",
            "dashboard_image_position": "ضبط موضع الصورة",
            "phone": "الهاتف",
