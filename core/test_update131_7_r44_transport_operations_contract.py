...
class Update1317R44TransportOperationsContractTests(SimpleTestCase):
    def test_release_identity_and_revision(self):
        ...
        self.assertRegex(manifest["version_name"], r"^OPAL Update 131\.7 R[0-9]+ - .+$")
        self.assertGreaterEqual(manifest["package_revision"], 52)
        self.assertIn("OPAL Update 131.7 R", manifest["baseline"])
