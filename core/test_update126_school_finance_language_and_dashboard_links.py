...
class Update126SchoolFinanceLanguageAndDashboardLinksTests(SimpleTestCase):
    ...
    def test_six_management_kpis_are_real_links_to_owning_gateways(self):
        ...
        expected = (
            ...
            ("accounting:dashboard", "#fee-summary"),
            ("accounting:dashboard", "#outstanding-balances"),
            ("exams:exam_cycle_center", ""),
        )
        for route_name, fragment in expected:
