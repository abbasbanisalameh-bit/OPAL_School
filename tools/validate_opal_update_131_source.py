...
def main() -> int:
    ...
    add_check(
        ...
        and "css/opal_theme_system.css" in base,
    ...
    add_check(
        ...
        "css/opal_theme_system.css" in base
        and '"css/opal_theme_system.css"' in subject_ui_contract
    ...
    css = require_file("static/css/opal_theme_system.css")
    add_check(
        "print_contract",
    ...
    dashboard_template = require_file("dashboard/templates/dashboard/home.html")
    dashboard_workflow = require_file("dashboard/workflow.py")
    dashboard_css = require_file("static/css/opal_theme_system.css")
    ...
    shared_css = require_file("static/css/opal_theme_system.css")
    add_check(
